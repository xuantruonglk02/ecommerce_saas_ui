...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status">
      <div id="status-icon" style={{backgroundColor: (STATUS_CONTENT_MAP as any)[status].iconColor}}>
        {(STATUS_CONTENT_MAP as any)[status].icon}
      </div>
      <h2 id="status-text">{(STATUS_CONTENT_MAP as any)[status].text}</h2>
