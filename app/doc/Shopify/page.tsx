...
export default function Component() {
  const steps = [
    "Log in to your Duda account and select the website you want to edit.",
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="mb-12 bg-muted/50">
        <CardContent className="pt-6">
          <h1 className="text-3xl font-bold mb-4">How to Add AppBars to Shopify</h1>
          <p className="text-muted-foreground text-lg">
            Duda is a web design platform for building responsive websites. Integrating AppBars popups can help you create more engaging and high-converting Duda websites.
          </p>
        </CardContent>
      </Card>
